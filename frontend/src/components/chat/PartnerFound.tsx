...
export default function PartnerFound() {
  return (
    <div className="flex-1 flex items-center justify-center pointer-events-none w-full h-full">
      {/* Converging glow (positioned behind but within the same centered area) */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-3 animate-[fadeIn_0.6s_ease-out]">
        ...
        <p className="text-sm text-text-main">You’re connected</p>
      </div>
    </div>
  );
}